...
**se_linux_options** | [**V1ContainerSecurityContextSeLinuxOptions**](V1ContainerSecurityContextSeLinuxOptions.md) |  | [optional] 
...
**sysctls** | [**list[V1PodSecurityContextSysctls]**](V1PodSecurityContextSysctls.md) | Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported sysctls (by the container runtime) might fail to launch. | [optional] 
**windows_options** | [**V1ContainerSecurityContextWindowsOptions**](V1ContainerSecurityContextWindowsOptions.md) |  | [optional] 
